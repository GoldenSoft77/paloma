    ...
    <section class="content">
      <div class="container-fluid p-5">
        ...
        <div class="card card-primary">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{ url('/welcome_page/store') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="card-body">
              <div class="form-group">
                <label>Title *</label>
                <input type="text" class="form-control @error('slide_title') is-invalid @enderror" name="slide_title" required>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('slide_para') is-invalid @enderror" name="slide_para" required>
